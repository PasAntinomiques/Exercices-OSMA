...
public class Initiator extends Agent {
	...
	protected void setup() {
  	...
  	if (args != null && args.length > 0) {
  		...
  		System.out.println("Agent "+getLocalName()+" : Requesting dummy-action to "+nResponders+" responders.");
...
//			Je suppose qu'il envoie le message avec ce comportement
			addBehaviour(new AchieveREInitiator(this, msg) {
				...
				protected void handleAllResultNotifications(Vector notifications) {
					if (notifications.size() < nResponders) {
						...
						System.out.println("Agent "+getLocalName()+" : Timeout expired: missing "+(nResponders - notifications.size())+" responses");
					}
				}
			} );
  	}
